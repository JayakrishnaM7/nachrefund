...
import com.ibm.org.model.sessiondialogue.UpdateQueryRequestQuery;
...
public class RetrieveQueryResponse   {
  ...
  public RetrieveQueryResponse customerContactSessionProcedure(UpdateCustomerContactSessionProcedureRequestCustomerContactSessionProcedure customerContactSessionProcedure) {
  ...
  */
  ...
  public RetrieveQueryResponse query(UpdateQueryRequestQuery query) {
    this.query = query;
    return this;
  }
  ...
  */
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RetrieveQueryResponse retrieveQueryResponse = (RetrieveQueryResponse) o;
    return Objects.equals(this.customerContactSessionProcedure, retrieveQueryResponse.customerContactSessionProcedure) &&
        Objects.equals(this.query, retrieveQueryResponse.query);
  }
  ...
  public String toString() {
    ...
    sb.append("class RetrieveQueryResponse {\n");
