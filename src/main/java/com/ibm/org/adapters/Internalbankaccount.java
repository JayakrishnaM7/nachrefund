...
@Component
public class Internalbankaccount implements JavaDelegate{

    @Autowired
    private Utility utility;

    @Autowired
    private InternalbankaccountRestProcessor restProcessor;

    private final static Logger LOGGER = Logger.getLogger(Internalbankaccount.class.getName());
    ...
    public void execute(DelegateExecution execution) throws Exception {
         ...
         if(response instanceof ApiError ||  response instanceof GenericError){
            //Failure Path
            throw new RuntimeException("Error occurred in the adapter:"+Internalbankaccount.class.getName());
         }else{
