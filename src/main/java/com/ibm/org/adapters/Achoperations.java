...
@Component
public class Achoperations implements JavaDelegate{

    @Autowired
    private Utility utility;

    @Autowired
    private AchoperationsRestProcessor restProcessor;

    private final static Logger LOGGER = Logger.getLogger(Achoperations.class.getName());
    ...
    public void execute(DelegateExecution execution) throws Exception {
         ...
         if(response instanceof ApiError ||  response instanceof GenericError){
            //Failure Path
            throw new RuntimeException("Error occurred in the adapter:"+Achoperations.class.getName());
         }else{
