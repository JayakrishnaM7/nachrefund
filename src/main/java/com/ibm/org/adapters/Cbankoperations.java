...
@Component
public class Cbankoperations implements JavaDelegate{

    @Autowired
    private Utility utility;

    @Autowired
    private CorrespondentbankoperationsRestProcessor restProcessor;

    private final static Logger LOGGER = Logger.getLogger(Cbankoperations.class.getName());
    ...
    public void execute(DelegateExecution execution) throws Exception {
         ...
         if(response instanceof ApiError ||  response instanceof GenericError){
            //Failure Path
            throw new RuntimeException("Error occurred in the adapter:"+Cbankoperations.class.getName());
         }else{
